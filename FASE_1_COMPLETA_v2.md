...
**Responsable:** Sofía · **Apoyo:** Steve, Kukis
...
| 12 | **Villavicencio** | Orinoquia | Intermedia (+500K hab) | A1, A4 | 🟢 Baja |
...
| Modelado supervisado | scikit-learn, xgboost, shap | Steve | ✅ Disponible |
...
**Total registros brutos de precios (antes de limpiar): ~1.825.000 filas**
...
> El dataset A4 (Properati) es la columna vertebral histórica 2015–2021. Los datasets A1, A2, A3, A5, A6 y A7 complementan y extienden hasta 2024. Juntos, cubren el período completo requerido.
...
| 9 | `salario_minimo_historico.xlsx` | **XLSX** | DANE | ✅ Sí |
...
| 14 | `ipvn_trimestral.xlsx` | **XLSX** | DANE | ✅ Sí |

**Total: 8 archivos CSV de precios + 6 archivos XLSX macro = 14 archivos en `/data/raw/`**
...
| R5 | Multicolinealidad entre variables macro (IPC, tasa hipotecaria) | Media | Medio | Calcular VIF; usar SHAP para selección de features |
| R6 | Ciudades intermedias con < 500 registros tras limpieza | Media | Medio | Documentar como limitación; excluir del modelo pero incluir en análisis descriptivo |
...
|---|---|---|
| 1–2 | **Fase 1:** Comprensión del negocio. Documento de planificación aprobado. | Sofía |
| 3–4 | **Fase 2:** Descarga de los 14 archivos, EDA inicial, reporte de calidad por dataset. | Steve |
...
- [x] **scikit-learn, xgboost, shap** disponibles
...
**Pendientes de ejecución (tarea Steve + Kukis, Sesión 2):**
...
## Guía Rápida de Descarga para Steve — Sesión 2
...
*Documento de Fase 1 · Versión 2 · Proyecto Accesibilidad Habitacional Colombia · CRISP-DM 2025-I*
