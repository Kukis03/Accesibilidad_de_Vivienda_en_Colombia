...
| 11 | `ipc_colombia_mensual.xlsx` | **XLSX** | DANE | ✅ Sí |
| 12 | `tasa_hipotecaria_mensual.xlsx` | **XLSX** | BanRep | ✅ Sí |
| 13 | `desempleo_ciudades_trimestral.xlsx` | **XLSX** | DANE GEIH | ✅ Sí |
| 14 | `ipvu_trimestral.xlsx` | **XLSX** | BanRep / datos.gov.co | ✅ Sí |
...
| 3–4 | **Fase 2:** Descarga de los 15 archivos, EDA inicial, reporte de calidad por dataset. | Sofía |
